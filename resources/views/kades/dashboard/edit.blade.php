...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_lengkap" placeholder="Nama" value="{{ old('nama_lengkap') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" placeholder="your_email@examp.com" value="{{ old('email') }}"
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('kades.updateRT', ['$id'=>$data->id]) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label for="rt">Nama RT</label>
                        <input type="text" name="nama_rt" placeholder="rt berapa" value="{{$data->nama_rt}}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" placeholder="Nama" value="{{$data->nama_lengkap}}"
                            class="form-control @error('nama_lengkap') is-invalid @enderror" required>
                        @error('nama_lengkap')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <label for="no_hp"> No HP </label>
                        <input type="text" name="no_hp" placeholder="08xxxx" value="{{$data->no_hp}}"
                            class="form-control @error('no_hp') is-invalid @enderror" required>
                        @error('no_hp')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <label for="email"> Email </label>
                        <input type="text" name="email" placeholder="your_email@examp.com" value="{{$data->email}}"
                            class="form-control @error('email') is-invalid @enderror" required>
                        @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
